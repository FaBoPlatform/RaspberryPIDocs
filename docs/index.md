# FaBo RaspberryPi Docs

## FaBo RaspberryPi Docsについて

FaBo RaspberryPi Docsは、RaspberryPiの学習用ドキュメントです。

## 修正依頼等

GithubのRepoに[Issues](https://github.com/FaBoPlatform/RaspberryPiDocs/issues)をあげる。
